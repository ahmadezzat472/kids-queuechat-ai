...
import { Search, Filter, MapPin, Star, Phone, Globe, Bookmark, MessageCircle } from "lucide-react";
...
const ofstedRatings = ["All", "Outstanding", "Good", "Requires Improvement", "Inadequate"];
...
const mockResults: SchoolResult[] = [
  {
    ...
    rating: 4.8,
    distance: "0.3 miles",
    description: "Outstanding primary school with excellent STEM programs and small class sizes. Strong focus on individual learning and creative arts.",
  ...
  },
  {
    ...
    rating: 4.6,
    distance: "0.5 miles",
    description: "Catholic primary school with strong community values and excellent pastoral care. Traditional approach with modern facilities.",
  ...
  },
  {
    ...
    rating: 4.5,
    distance: "0.8 miles",
    description: "Comprehensive secondary school with strong academic results and diverse extracurricular activities. Excellent university preparation.",
  ...
  },
  {
    ...
    rating: 4.9,
    distance: "1.2 miles",
    description: "Private school offering small class sizes, extensive facilities, and personalized learning approaches. Strong academic track record.",
...
export default function ClassicSearch({ mode, onToggleMode }: ClassicSearchProps) {
  ...
  const handleSearch = () => {
    ...
    console.log("Searching for:", { searchQuery, location, schoolType, ofstedRating });
  };
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="border-b border-border bg-card p-4">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-xl font-semibold text-foreground">School Search</h1>
            <p className="text-sm text-muted-foreground">
              {mode === "classic" ? "Find schools using traditional search filters" : "AI-powered school search"}
            </p>
          </div>
          <button
        ...
        <div className="space-y-3">
          ...
          {showFilters && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 p-4 border border-border rounded-lg bg-muted/50">
              <div>
                <label className="block text-sm font-medium text-foreground mb-1">School Type</label>
                <select
                  value={schoolType}
              ...
              <div>
                <label className="block text-sm font-medium text-foreground mb-1">Ofsted Rating</label>
                <select
                  value={ofstedRating}
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <h3 className="text-lg font-semibold text-card-foreground">{school.name}</h3>
                  ...
                  <div className="flex items-center gap-4 text-sm text-muted-foreground mb-3">
                    ...
                    {school.fees && (
                      <span className="text-primary font-medium">{school.fees}</span>
                    )}
                  </div>
